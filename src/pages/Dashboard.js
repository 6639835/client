  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <main className="container mx-auto px-4 pb-12">
        {/* Welcome banner */}
        <div className="bg-slate-900 rounded-lg mt-6 p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex mt-4 md:mt-0 space-x-2">
              ...
              <Button
                variant="destructive"
                onClick={handleLogout}
                className="bg-red-900 hover:bg-red-800 border-none text-slate-200"
              >
        ...
        <section className="mb-6">
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            <Card className="bg-slate-900 border-none">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{stats.daysActive} days</div>
            ...
            <Card className="bg-slate-900 border-none">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{stats.loginCount}</div>
                <p className="text-xs text-slate-400 mt-1 flex items-center">
                  <TrendingUp className="h-3 w-3 mr-1 text-green-500" />
            ...
            <Card className="bg-slate-900 border-none">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{stats.securityScore}%</div>
              ...
              <Card className="bg-slate-900 border-none">
                <CardHeader className="border-b border-slate-800 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">Your profile details and account settings</p>
                    </div>
                    <Button 
                      variant="outline" 
                      size="sm" 
                ...
                <div className="p-5 space-y-5">
                  <div className="flex items-center">
                    <UserCircle className="mr-3 h-5 w-5 text-slate-500" />
                    <span className="font-medium text-slate-400 w-32">Name:</span>
                    <span className="text-white">{profile.name}</span>
                  </div>
                  <div className="flex items-center">
                    <Mail className="mr-3 h-5 w-5 text-slate-500" />
                    <span className="font-medium text-slate-400 w-32">Email:</span>
                    <span className="text-white">{profile.email}</span>
                  </div>
                  <div className="flex items-center">
                    <Calendar className="mr-3 h-5 w-5 text-slate-500" />
                    <span className="font-medium text-slate-400 w-32">Account Created:</span>
                ...
                <CardHeader className="border-b border-slate-800 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">Your login activity over time</p>
                    </div>
                  </div>
                </CardHeader>
                <div className="p-6 flex flex-col items-center justify-center">
                  <div className="flex justify-center items-center h-48 opacity-30">
                    <svg className="w-48 h-48" viewBox="0 0 200 100">
                      <rect x="10" y="70" width="20" height="30" fill="#94a3b8" />
                      <rect x="40" y="40" width="20" height="60" fill="#94a3b8" />
                      <rect x="70" y="60" width="20" height="40" fill="#94a3b8" />
                      <rect x="100" y="20" width="20" height="80" fill="#94a3b8" />
                      <rect x="130" y="50" width="20" height="50" fill="#94a3b8" />
                      <rect x="160" y="30" width="20" height="70" fill="#94a3b8" />
                    </svg>
                  </div>
